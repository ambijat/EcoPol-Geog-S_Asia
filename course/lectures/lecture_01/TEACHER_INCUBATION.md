---
document_title: Lecture 1A teacher incubation record
...
# Lecture 1A teacher incubation

## Governing distinction

The 65-slide inherited ODP is the canonical Lecture 1A pilot master and the
object of teacher incubation.

The 15-slide v0.5 artifact is a synoptic companion. It helps the instructor see
the whole argument, but it does not replace, reduce or become the revised
master.
...
- visual treatment;
- speaker cue and approximate time;
- whether the decision is provisional or confirmed.

## Review units

| Unit | Slides | Function | Instructor status |
|---|---:|---|---|
| Opening frame | 1–2 | Title, scope and map disclaimer | NOT_STARTED |
| KC01 | 3–18 | Regional imagination and ways of knowing South Asia | IN_PROGRESS |
| KC02 | 19–27 | Environment and society | NOT_STARTED |
| KC03 | 28–39 | Population and political economy | NOT_STARTED |
| KC04 | 40–46 | Concept of region | NOT_STARTED |
| KC05 | 47–56 | South Asia as regional formation | NOT_STARTED |
