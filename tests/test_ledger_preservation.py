...
class LedgerPreservationTests(unittest.TestCase):
    def test_existing_eleven_block_chain_and_first_eight_history_are_preserved(self) -> None:
        ...
        self.assertEqual(blocks[10]["block_number"], 11)
        self.assertEqual(blocks[10]["block_type"], "WORKFLOW_EVENT")
        self.assertEqual(blocks[10]["approved_by"], "Instructor")
        self.assertEqual(blocks[10]["approval_status"], "APPROVED")
        self.assertEqual(blocks[10]["academic_approval_effect"], "NONE")
        self.assertEqual(blocks[10]["fidelity_advancement_effect"], "NONE")
        self.assertEqual(
            blocks[10]["previous_block_hash"],
            blocks[9]["content_hash"],
        )
        self.assertEqual(
            blocks[10]["content_hash"],
